<div class="page-header">
    <div class="header-wrapper row m-0">
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="#">Shopsis</a></div>
        ...
        <ul class="nav-menus">
          ...
          <li class="cart-nav onhover-dropdown">
            ...
            <div class="cart-dropdown onhover-show-div">
              ...
              <ul class="custom-scrollbar">
                <li>
                  <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{ asset('admin-assets/images/banner-1.jpg')}}"
                      alt="">
                    <div class="media-body">
                      <h5>پیراهن مشکی با ژاکت</h5>
                ...
                <li>
                  <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{ asset('admin-assets/images/product-4.png')}}"
                      alt="">
                    <div class="media-body">
                      <h5>پیراهن سفید و زرد</h5>
                      <p class="f-w-700">500,000 تومان</p>
                      <div class="cart-quantity"> <span class="plus"><i class="fa fa-plus"></i></span>
                        <input class="count" type="text" name="qty" value="3"><span class="minus"><i
                            class="fa fa-minus"></i></span>
                ...
                <li>
                  <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{ asset('admin-assets/images/product-6.jpg')}}"
                      alt="">
                    <div class="media-body">
                      <h5>کتونی مشکی نایکی</h5>
                      <p class="f-w-700">500,000 تومان</p>
                      <div class="cart-quantity"> <span class="plus"><i class="fa fa-plus"></i></span>
                        <input class="count" type="text" name="qty" value="3"><span class="minus"><i
                            class="fa fa-minus"></i></span>
                ...
                <li class="order-total">
                  <h4 class="mb-0 f-w-700">مجموع : <span>1,500,000 ت</span></h4><a
                    class="btn btn-primary view-checkout" href="#">پرداخت</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="onhover-dropdown">
            ...
            <div class="onhover-show-div notification-dropdown">
              ...
              <ul class="custom-scrollbar">
                <li>
                  <div class="media">
                    <div class="notification-img bg-light-primary"><img src="{{ asset('admin-assets/images/avtar/man.png')}}" alt="">
                    </div>
                    <div class="media-body">
                      <h5>پدرام شریفی</h5>
                ...
                <li>
                  <div class="media">
                    <div class="notification-img bg-light-secondary"><img src="{{ asset('admin-assets/images/avtar/teacher.png')}}"
                        alt=""></div>
                    <div class="media-body">
                      <h5>پدرام شریفی</h5>
                ...
                <li>
                  <div class="media">
                    <div class="notification-img bg-light-info"><img src="{{ asset('admin-assets/images/avtar/teenager.png')}}" alt="">
                    </div>
                    <div class="media-body">
                      <h5>پدرام شریفی</h5>
                ...
                <li>
                  <div class="media">
                    <div class="notification-img bg-light-success"><img src="{{ asset('admin-assets/images/avtar/chinese.png')}}"
                        alt=""></div>
                    <div class="media-body">
                      <h5>پدرام شریفی</h5>
          ...
          <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
            ...
            <ul class="profile-dropdown onhover-show-div">
              <li><a href="#"><i data-feather="user"></i><span>حساب کاربری </span></a></li>
              <li><a href="#"><i data-feather="mail"></i><span>صندوق دریافت</span></a></li>
              <li><a href="#"><i data-feather="file-text"></i><span>میز کار</span></a></li>
              <li><a href="#"><i data-feather="settings"></i><span>تنظیمات</span></a></li>
              <li><a href="#"><i data-feather="log-in"> </i><span>خروج</span></a></li>
            </ul>
          </li>
        </ul>
      </div>
